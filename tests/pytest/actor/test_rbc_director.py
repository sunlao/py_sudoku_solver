...
async def test_state(
        handler_solo, startup_message, test_actor_domain_state
    ):
    ...
    expected = await eval._eval_all(side_effects, rbc_init)
    ...
    await eval.director(side_effects, message)
    ...
    expected = await eval._eval_all(side_effects, rbc)
