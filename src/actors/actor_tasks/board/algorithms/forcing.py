    ...
    def forcing_chains(self, board: Board) -> Board:
        ...
        for pivot in bivalue:
            ...
            for original, branch_a_cell, branch_b_cell in zip(
                ...
                original_candidates = cell_candidates(original)
                if not original_candidates:
                    continue
                removed_a = original_candidates - cell_candidates(branch_a_cell)
                removed_b = original_candidates - cell_candidates(branch_b_cell)
